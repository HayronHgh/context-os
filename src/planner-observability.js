...
export function plannerMetrics({ input, plan, validatedPlan, plannerRun = null }) {
  ...
  return {
    ...
    failedAttempts: plannerRun?.failedAttempts ?? null,
    parseFailures: plannerRun?.parseFailures ?? null,
    protocolFailures: plannerRun?.failures?.protocol ?? null,
    bindingFailures: plannerRun?.failures?.binding ?? null,
    visibilityFailures: plannerRun?.failures?.visibility ?? null,
    clientFailures: plannerRun?.failures?.client ?? null,
    staleFailures: plannerRun?.failures?.stale ?? null,
